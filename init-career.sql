-- P2A Career Module Database Initialization
...
-- Create enums for Career Module
DO $$ BEGIN
...
-- Sample company
-- INSERT INTO "companies" ("user_id", "name", "description", "contact_email", "company_type", "verification_status") 
-- VALUES ('00000000-0000-0000-0000-000000000001', 'Tech Company Vietnam', 'Leading technology company in Vietnam', 'hr@techcompany.vn', 'enterprise', 'verified');

-- Sample job
-- INSERT INTO "jobs" ("company_id", "title", "description", "requirements", "benefits", "job_type", "status", "is_remote", "is_urgent")
-- VALUES (
...
DO $$
BEGIN
    RAISE NOTICE 'P2A Career Module database initialization completed successfully!';
    RAISE NOTICE 'Database: p2a_career';
