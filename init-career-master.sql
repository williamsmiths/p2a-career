-- P2A Career Module Master Database Initialization
-- This script runs when PostgreSQL Master container starts for the first time
...
DO $$
BEGIN
    RAISE NOTICE 'P2A Career Module Master database initialization completed successfully!';
    RAISE NOTICE 'Database: p2a_career (Master)';
